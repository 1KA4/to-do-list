...
function isEmailExist($user_email, $db_connection){  // Check user email in DB
...
function addUser($user_email, $user_password, $db_connection){  // Add user to DB
        ...
        <div class="row  justify-content-center">
            <div class="card col-lg-5 card-body">
                ...
                <form action="#" method="POST" class="text-center">
                    <input type="email" class="form-control my-4 text-center" name="email" placeholder="name@example.com" value="test@test.com" required>
                    <input type="password" class="form-control text-center" name="password" placeholder="Password" value="test" required>
                        <?php
                            if(isset($result)){
                                echo "<div class='alert alert-danger my-1'> $result </div>";
                            }
                        ?>
                    <button class="btn btn-outline-info mt-4 px-5" type="submit" id="submit" name="signin">Sing in</button>
                </form>
