...
<link rel="apple-touch-icon" sizes="76x76" href="../img/favicon/apple-touch-icon.png">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Anton&family=Black+Ops+One&family=Space+Grotesk:wght@600&display=swap" rel="stylesheet">
</head>
<body>
    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-primary">
        ...
        <div class="collapse navbar-collapse" id="mainNavbar">
            ...
            <div class="text-md-right text-white">
                    <a href="../login.php" class="btn btn-outline-light" id="profil"><i class="fas fa-sign-out-alt"></i> Sign Out</a>
            </div>
        </div>
    </nav>
    ...
    <div class="row">
  		<div class="col-lg-10 text-center"><h1><?php echo getUserName($connection); ?></h1></div>
        ...
        <div class="text-center" id="btnImage">
          ...
          <ul class="list-group mt-5">
            ...
            <div class="list-group-item ">
                ...
                <span class="user-email"><?php echo getUserEmail(); ?></span>
            </div>
            <div class="list-group-item">
          ...
          <ul class="list-group mt-3">
            ...
            <div class="list-group-item ">
                <a href="https://www.facebook.com/profile.php?id=100009734865470/"><i class="fa fa-facebook fa-2x"></i></a>
                <a href="https://github.com/1KA4/"><i class="fa fa-github fa-2x"></i></a>
                <a href="https://1ka4.github.io/"><i class="far fa-address-card fa-2x"></i></a>
            </div>
          </ul> 
                           ...
                           <div class="col-lg-12">
                                ...
                                ?>
                              	<button class="btn btn-success" type="submit" name="update_name">Save</button>
                               	<button class="btn btn-outline-secondary" type="reset">Reset <i class="fas fa-sync-alt"></i></button>
                            </div>
                      </div>
              	</form>
             </div><!--/tab-Setting-->
